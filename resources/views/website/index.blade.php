...
@section('body')
    ...
    <section class="product-category">
        <div class="container">
            ...
            <div class="category-section">
                @foreach ($someCategories as $someCategory)
                    <div class="product-wrapper" data-aos="fade-right" data-aos-duration="100">
                        <div class="wrapper-img">
                            <img src="{{ asset($someCategory->icon)}}" alt="{{$someCategory->name}}">
                        </div>
                        <div class="wrapper-info">
                            <a href="{{ route('website.categories.products', $someCategory->slug)}}"
                                class="wrapper-details">{{$someCategory->name}}</a>
                        </div>
                    </div>
                @endforeach
            </div>
    ...
    <section class="product brand" data-aos="fade-up">
        <div class="container">
            ...
            <div class="brand-section">
                @foreach ($someBrands as $someBrand)
                    <div class="product-wrapper">
                        <div class="wrapper-img">
                            <a href="{{ route('website.brands.products', $someBrand->slug)}}">
                                <img src="{{ asset($someBrand->logo)}}" alt="{{$someBrand->name}}">
                            </a>
                        </div>
                    </div>
                @endforeach
    ...
    {{-- new arrival latest product section --}}
    @if ($homePageProducts['newArrivals']->count() > 0)
        <section class="product arrival">
            <div class="container">
                <div class="section-title">
                    <h5>NEW ARRIVALS</h5>
                    <a href="{{route('website.products.type','new-arrivals')}}" class="view">View All</a>
                </div>
        ...
        <section class="product flash-sale">
            <div class="container">
                <div class="section-title">
                    ...
                    <a href="{{route('website.products.type','flash-timer')}}" class="view">View All</a>
                </div>
                <div class="flash-sale-section">
                    <div class="row g-5">

                        @foreach ($homePageProducts['flashProductsTimer'] as $product)
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-description">
                                        ...
                                        <div class="price">
                                            ...
                                            @endif
                                             {{-- السعر القديم --}}
                                            {{-- <span class="price-cut">{{ $product->price }} + {{$product->available_for}} EGP</span> --}}
                                            {{-- <span class="new-price">{{ $product->getPriceAfterDiscount() }} EGP</span> --}}
                                        </div>
                                    </div>
                                </div>
                                <div class="product-cart-btn">
                                    <a href={{route('website.categories.products', $product->category->slug)}}"" class="product-btn">{{$product->category->name}}</a>
                                </div>
                            </div>
                        </div>
                        @endforeach
                ...
                <div class="row g-5">
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="{{ asset('assets/website')}}/assets/images/homepage-one/product-img/product-img-5.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="{{ asset('assets/website')}}/assets/images/homepage-one/product-img/product-img-6.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="{{ asset('assets/website')}}/assets/images/homepage-one/product-img/product-img-7.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="{{ asset('assets/website')}}/assets/images/homepage-one/product-img/product-img-8.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="{{ asset('assets/website')}}/assets/images/homepage-one/product-img/product-img-10.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
            ...
            <div class="weekly-sale-section">
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="{{ asset('assets/website')}}/assets/images/homepage-one/product-img/product-img-9.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
    ...
    @if ($homePageProducts['flashProducts']->count() > 0)
        <section class="product best-product">
            <div class="container">
                <div class="section-title">
                    <h5>Flash Sale</h5>
                    <a href="{{route('website.products.type','flash-products')}}" class="view">View All</a>
                </div>
