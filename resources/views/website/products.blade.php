                                                            ...
                                                            <div class="countdown-section">
                                                                ...
                                                                <div class="countdown-items">
                                                                    <span id="hour" class="number"
                                                                        style="color: skyblue;">0</span>
                                                                    <span class="text">Hours</span>
                                                                </div>
                                                                <div class="countdown-items">
                                                                    <span id="minute" class="number"
                                                                        style="color: green;">0</span>
                                                                    <span class="text">Minutes</span>
                                                                </div>
                                                                <div class="countdown-items">
                                                                    <span id="second" class="number"
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="product-wrapper" data-aos="fade-up">
                                                    ...
                                                    <div class="price">
                                                        @if ($product->has_variants == 0)
                                                            @if ($product->has_discount == 0)
                                                                <span class="new-price">{{ number_format($product->price) }} EGP</span>
                                            ...
                                            <div class="product-cart-btn">
                                                <a href="cart.html" class="product-btn">view Details</a>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
...
@push('js')
    ...
    <script>
        function startCountDown(){
            ...
            // هحول من ميلي سكند ل سند
            const totalSeconds = Math.floor(diff / 1000);

            // ساعه فيها كام ثانيه3600 
            // 86400 باقي عدد الثواني ف اليوم الواحد
            const hours = Math.floor((totalSeconds % 86400) / 3600);// تقريب للاسفل floor

            // الدقايق فيها كام ثانيه60 
            const minutes = Math.floor((totalSeconds % 3600) / 60); // 3600 الدقايق المتبقيه ف الساعه
            const seconds = totalSeconds % 60; // 

            $("#day").text("0"); // المنتج ليوم واحد فقط 0
