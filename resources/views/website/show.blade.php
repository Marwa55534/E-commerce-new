                        ...
                        <div class="product-info-img">
                            <div class="swiper product-top">
                                <div class="product-discount-content">
                                    <h4>{{$product->discountPercentege()}}</h4>
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="product-info-content">
                            ...
                            <div class="product-quantity">
                                ...
                                @livewire('website.wishlist.product-wishlist', ['product' => $product])
                            ...
                            <div class="product-details">
                                <p class="category">Category : <span class="inner-text">{{$product->category->name}}</span>
                                </p>
                                {{-- <p class="tags">Tags : <span class="inner-text">{{$product->tag}}</span></p> --}}
            ...
            <div class="product-detail-section">
                ...
                <div class="tab-content tab-item" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="nav-review" role="tabpanel" aria-labelledby="nav-review-tab"
                        tabindex="0">
                        @livewire('website.review',['product'=>$product])
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="product weekly-sale product-weekly footer-padding">
        <div class="container">
            <div class="section-title">
                ...
                <a href="{{route('website.products.relatedProducts', $product->slug)}}" class="view">View All</a>
            </div>
