                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input readonly name="youtupe"
                                                        class="form-control border-primary " type="url"
                                                        placeholder="{{ __('dashboard.youtube') }}" id="userinput5"
                                                        value="{{ $setting->youtupe }}">
                                                    @error('youtupe')
                                                        <strong class="text-danger"> {{ $message }}</strong>
                                                    @enderror
                                                </div>
