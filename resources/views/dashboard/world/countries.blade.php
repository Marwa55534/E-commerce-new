    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">{{ __('dashboard.countries_table') }}</h3>
                                ...
                                <tbody>
                                    ...
                                    @forelse ($countries as $country)
                                        <tr>
                                            ...
                                            <td><a href="{{ route('dashboard.governorates.index' , $country->id) }}">{{ $country->name }}</a> <i class="flag-icon flag-icon-{{ $country->flag_code }}"></i> </td>
                                            <td>
...
<script>
    // فاول حاجه بقوله لما تعمل تغيير على الانبوت اللي هو
    $(document).on('change', '.change_status', function() {

        //id اول حاجه ان هي بتجيب
        //country تمام اللي هو بتاع  
       // هجيبه ازاي this دي بتعود على
       // ايه بالظبط كده على الكلاس اللي انا ضغطت عليه او المكان اللي انا ضغطت فيه اللي انا بستدعي الكلاس بتاعه تمام هاتلي
        var id = $(this).attr('country-id');
        var url = "{{ route('dashboard.countries.changeStatus', ':id') }}";
