    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" class="form" id="CreateUserForm" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        <label for="mobile">{{ __('dashboard.mobile') }}</label>
                        <input type="text" name="mobile" class="form-control" placeholder="{{ __('dashboard.mobile') }}">
                    </div>
