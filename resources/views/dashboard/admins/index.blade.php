        ...
        <div class="content-body">
            <div class="card">
                ...
                <div class="card-content"> 
                    <div class="card-body">
                        <a href="{{ route('admins.create') }}" class="btn btn-danger">{{ __('dashboard.add') }}</a><br><br>
                        
                        <input name="ajax_search_value" id="ajax_search" placeholder="Search here ...." class="form-control"><br><br>
