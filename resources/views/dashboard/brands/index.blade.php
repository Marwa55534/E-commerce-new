                ...
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('brands.index') }}">{{ __('dashboard.brands') }}</a>
                            </li>
        ...
        <div class="content-body">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="basic-layout-colored-form-control">{{ __('dashboard.brands') }}
                    </h4>
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        {{-- modal --}}
                        @include('dashboard.brands.createBrand')
