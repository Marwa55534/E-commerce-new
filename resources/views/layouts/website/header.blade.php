            ...
            <div class="header-top">
                <div class="header-profile">
                    @if (Auth::guard('web')->check())
                        <a href="{{route('website.profile.index')}}"><span>{{auth('web')->user()->name}}</span></a>
                    @endif
                    <a href="order.html"><span>Track Order</span></a>
                    <a href="{{route('website.faqs.index')}}"><span>Support</span></a>
                </div>
                                        ...
                                        <div class="dropdown-item d-flex justify-content-between align-items-center">
                                            <div class="dropdown-list-item d-flex">
                                                <span class="dropdown-img">
                                                    <img src="{{ asset($category->icon) }}" alt="baby">
                                                </span>
                            ...
                            <ul class="header-sub-menu">
                                @if ($pages->count() > 0)
                                    @foreach ($pages as $page)
                                        <li><a href="{{route('website.DynamicPage', $page->slug)}}">{{$page->title}}</a></li>
                                    @endforeach
                                @endif
                ...
                <div class="header-vendor-btn">
                    @if (app()->getLocale() == 'ar')
                        <a rel="alternate" href="{{ LaravelLocalization::getLocalizedURL('en', null, [], true) }}"
                            class="shop-btn">
                            <span class="list-text shop-text">English</span>
                            <span class="icon">
                    ...
                    @else
                        <a rel="alternate" href="{{ LaravelLocalization::getLocalizedURL('ar', null, [], true) }}"
                            class="shop-btn">
                            <span class="list-text shop-text">Arabic</span>
                            <span class="icon">
                                <svg width="24" height="16" viewBox="0 0 24 16" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
