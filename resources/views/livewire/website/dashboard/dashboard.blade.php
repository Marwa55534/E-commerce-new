<div>
   @if ($screen == 'dashboard')
        <div class="tab-pane fade @if($screen == 'dashboard') show active @endif ">
        <div class="user-profile">
            <div class="user-title">
                <p class="paragraph">Hello {{auth('web')->user()->name }}</p>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="product-wrapper">
                            ...
                            <div class="wrapper-content">
                                ...
                                <h3 class="heading">{{$new_order_count}}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        <div class="product-wrapper">
                            ...
                            <div class="wrapper-content">
                                ...
                                <h3 class="heading">{{$delivered_order_count}}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                                ...
                                <div class="info-list">
                                    ...
                                    <div class="info-details">
                                        ...
                                        <p><a href="https://quomodothemes.website/cdn-cgi/l/email-protection"
                                                class="__cf_email__"
                                                data-cfemail="cbafaea6a4aea6aaa2a78baca6aaa2a7e5a8a4a6">{{$auth_user->email}}</a>
                                        </p>
