                ...
                <table>
                    <tbody>
                        ...
                        @foreach ($cartItems as $cartItem)
                            ...
                            <td class="table-wrapper wrapper-product">
                                <div class="wrapper">
                                    <div class="wrapper-img">
                                        <img src="{{asset('uploads/products/' . $cartItem->product->images()->first()->file_name) }}" alt="img">
                                    </div>
                                    <div class="wrapper-content">
                                        <h5 class="heading">{{$cartItem->product->name}}</h5>
                                    </div>
                                </div>
                            </td>
                            <td class="table-wrapper">
                                <div class="table-wrapper-center">
                                    <h5 class="heading">{{$cartItem->price}}</h5>
                                </div>
                            </td>
                            <td class="table-wrapper">
                                <div class="table-wrapper-center">
                                    <div class="quantity">
                                        <a href="" wire:click.prevent="decrementQuantity({{$cartItem->id}})" class="minus">
                                            -
                                        </a>
                                        <span class="number">{{$cartItem->quantity}}</span>
                                        <a href="" wire:click.prevent="incrementQuantity({{$cartItem->id}})" class="plus">
                                            +
                                        </a>
                                    </div>
                                </div>
                            ...
                            <td class="table-wrapper wrapper-total">
                                <div class="table-wrapper-center">
                                    {{-- <h5 class="heading">{{$cartItem->price + $cartItem->quantity}}</h5> --}}
                                    <h5 class="heading">{{$cartItem->price * $cartItem->quantity}}</h5>
                            ...
                            <td class="table-wrapper ">
                                <div class="table-wrapper-center">
                                    ...
                                    @foreach ($cartItem->attributes as $attribute=>$value)
                                        <h4 style="margin-right: 4px" class="heading">{{$attribute . ':' . $value}}</h4>
                                    @endforeach
                            ...
                            <td class="table-wrapper">
                                <div class="table-wrapper-center">
                                    <a href="javascript:void(0)" wire:click.prevent="removeItem({{$cartItem->id}})">
